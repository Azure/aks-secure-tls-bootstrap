...
//
//	mockgen -package=mocks -copyright_file=../hack/copyright_header.txt -source=pkg/gen/akssecuretlsbootstrap/v1/service_grpc.pb.go -destination=pkg/gen/mocks/akssecuretlsbootstrap/v1/service.go
//
